...
For secure, zero-config SSH access without port forwarding, see the **[Tailscale SSH Guide](ACCESS_CONTROL.md#ssh-access-via-tailscale)** in the Access Control documentation.
